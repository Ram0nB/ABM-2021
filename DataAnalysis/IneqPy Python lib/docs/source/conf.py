...
# -*- coding: utf-8 -*-
#
# IneqPy documentation build configuration file, created by
# sphinx-quickstart on Mon Dec 12 11:42:52 2016.
#
...
extensions = [
    ...
    'sphinx.ext.todo',
    'sphinx.ext.mathjax',
    'sphinx.ext.napoleon', # we chose to use napoleon because, although
    #'numpydoc', # numpydoc looks slightly tidier, it does not support the "Todo" keyword (and maybe others)
]
...
def autodoc_skip_member(app, what, name, obj, skip, options):
    ...
    #print(what+': '+name+' skip: '+skip.__str__())
    exclude = False
    return skip or exclude
    #return False

# Register function to skip members from autodoc listings
def setup(app):
...
latex_documents = [
    (master_doc, 'IneqPy.tex', 'IneqPy Documentation',
     'Maximiliano Greco', 'manual'),
]
...
man_pages = [
    (master_doc, 'IneqPy', 'IneqPy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IneqPy', 'IneqPy Documentation',
     author, 'IneqPy', 'One line description of project.',
     'Miscellaneous'),
]
